...
public class ObjectTouch : MonoBehaviour {
	...
	void On_SimpleTap(Gesture gesture){
		...
		if (gesture.pickObject == gameObject){
			...
			if (child==null){
                ...
                ring.GetComponent<Renderer>().material.SetColor("_TintColor", GetComponent<Renderer>().GetComponent<Material>().GetColor("_TintColor"));
	...
	void On_Drag(Gesture gesture){
		...
		if (gesture.pickObject == gameObject){
			...
			this.GetComponent<Rigidbody>().position = position - deltaPosition;
		}
